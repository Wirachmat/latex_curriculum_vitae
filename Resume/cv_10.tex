...
pdfkeywords={Manns, Mayen, Bewerbung, IT, Social Media, Community, Linux, Programmierer, Dispatcher, Buchautor} %%
}
\usepackage{pdfpages}
\usepackage{graphicx}
\usepackage{xltxtra}
...
\addbibresource{../Anlagen/Bibliographie/bibliography1.bib} % Specify the bibliography file to include publications
%\input{entity.tex}
...
\begin{center}
\includegraphics[scale=0.7]{../Bilder/signatur.png} \\
\begin{tabular}{@{}l@{}}
...
% Include PDF
\begin{figure}  
  \includegraphics[page=1,scale=0.7,angle=180]{../Anlagen/Arbeitszeugnisse/hays.pdf}
\end{figure}
\includepdf{../Anlagen/Studium/foo}
%\includepdf{../Anlagen/Arbeitszeugnisse/hays}
\includepdf{../Anlagen/Zertifikate/thm-webeng1}
\includepdf{../Anlagen/Arbeitszeugnisse/openslx}
\includepdf{../Anlagen/Arbeitszeugnisse/openslx1}
\includepdf{../Anlagen/Zertifikate/kompetenzpass12013}
\includepdf{../Anlagen/Zertifikate/Zertifikat_Sascha_Manns1}
\includepdf{../Anlagen/Arbeitszeugnisse/wtg}
\includepdf{../Anlagen/Ausbildungszeugnisse/ihk}
